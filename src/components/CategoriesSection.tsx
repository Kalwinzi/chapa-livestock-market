        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {livestockCategories.map((category, index) => (
            <div
              ...
              className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 hover:border-primary-500 cursor-pointer group"
            >
